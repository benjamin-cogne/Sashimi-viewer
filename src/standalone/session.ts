...
export function buildSession(args: {
  ...
  const viewerOf = (state: ViewerState): SessionViewer => ({
    ...
    consensusMode: state.consensusMode, minIndelBp: state.minIndelBp, longReadMinVafPct: state.longReadMinVafPct, coverageVariants: state.coverageVariants, pairs: state.pairs, haplotypes: state.haplotypes,
  });
