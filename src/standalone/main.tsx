...
function App() {
  ...
  return (
    <div className="min-h-screen bg-gray-100 text-gray-900">
      ...
      <footer className="px-5 py-3 text-[11px] text-gray-500">
        Same engine as the RNA-seq outlier explorer's Sashimi tab: junction arcs, equal-intron mode, reads with mismatches, variant sites and consensus collapsing. Large windows are limited to 5 Mb (coverage) and 250 kb (reads).
      </footer>
    </div>
  );
}
